...
;require.register("scripts/controls/quib.js", function(exports, require, module) {
'use strict';

var $ = require('jquery');
var info = require('../models/data');
console.log("............ INFO:");
console.log(info.application.project, " | ", info.application.developer);
...
module.exports = module.exports = {
    application: {
        ...
        version: 1.0,
        developer: "aQuib Sylvester (ACCF)"
    },
    settings: {
        platform: true,
    }
